...
author: "Grupo 8:  Corsniaky Matias, Remus Ezequiel, Reyes Andres "
date: ""
output:
  html_document:
    df_print: paged
...
horas
```
Notemos, que de esta manera nos queda el tiempo en horas, pero no del todo, pues
los decimales me estan indicando la cantidad de minutos y no la cantidad de horas en decimal.

Una de las cosas que podemos hacer es, dividir por el punto horas de minutos.
Luego, pasamos las horas a minutos y a estos les sumamos los minutos restantes
y luego pasamos estos minutos a horas.
